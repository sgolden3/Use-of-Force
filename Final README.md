...
Our key SQL and Pandas workflows helped our team explore, create queries and clean our Use of Force and Encampments data sets.
...
7. Tools used and how your team collaborated.
   - Thorughout the quarter, we primarily used Jupyter Lab, Google Colab, and Visual Studio Code for our python coding, with our primary libraries being pandas and numpy. We used DB Browser for sqlite for our SQL and data management code, along with visual basic for both of these processes as well.
